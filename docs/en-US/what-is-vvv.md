...
1. PHP [xdebug extension](https://xdebug.org/)
...
1. [ngrep](https://github.com/jpr5/ngrep/)
1. [dos2unix](https://waterlan.home.xs4all.nl/dos2unix.html)
1. [Composer](https://getcomposer.org/)
1. [phpMemcachedAdmin](https://github.com/elijaa/phpmemcachedadmin)
